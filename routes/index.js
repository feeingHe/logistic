...
const baseRouter = require('./api/base'); // 引入user路由模块
const logRouter = require('./api/log'); // 引入user路由模块
...
router.use('/api', baseRouter); // base路由模块
router.use('/api', logRouter); // base路由模块
